...
/***/ function(module, exports, __webpack_require__) {
	...
	function renderResource(f) {
	  return _underscore2.default.map(_Util2.default.trim(f.contentsection).replace(/[\u201C\u201D]/g, '"').split('\n'), function (line) {
	    return line + '<br />';
	  }).join('');
	}
	...
	_Sheet2.default.load(SPREADSHEET_ID, 4, function (rows) {
	  var resources = _underscore2.default.map(rows, function (row) {
	    return _Sheet2.default.parseRow(row);
	  }),
	      introHeader = resources[0].introheader,
	      sideColumn = _underscore2.default.map(resources[0].sidecolumn.split('\n'), function (l) {
	    return '<li>' + l + '</li>';
	  });
	
	  (0, _jquery2.default)('.resources-intro').html(introHeader);
	  (0, _jquery2.default)('.resources-aside').html(sideColumn);
	  (0, _jquery2.default)('.resources-index').html(_underscore2.default.map(resources, function (f, i) {
	    return '<li><a href="#q' + i + '">' + f.contentheader.toUpperCase() + '</a></li>';
	  }).join(''));
	
	  (0, _jquery2.default)('.resources-resources').html(_underscore2.default.map(resources, function (f, i) {
