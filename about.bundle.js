...
/***/ function(module, exports, __webpack_require__) {
	...
	_Sheet2.default.load(SPREADSHEET_ID, 1, function (rows) {
	  ...
	  _underscore2.default.each(rows, function (row) {
	    ...
	    obj.core = _Util2.default.parseBool(obj.core);
	    if (obj.core) {
	      core.push(obj);
	    } else {
	      nonCore.push(obj);
	  ...
	  (0, _jquery2.default)('.contributors-core').append(_Util2.default.joinAnd(_underscore2.default.map(core, function (c) {
	    if (c.url) {
	  ...
	  (0, _jquery2.default)('.contributors-more').append(_Util2.default.joinAnd(_underscore2.default.map(nonCore, function (c) {
	    if (c.url) {
	      return '<a href="' + c.url + '" target="_blank">' + c.name + '</a>';
	    } else {
	      return c.name;
