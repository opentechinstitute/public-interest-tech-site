...
/***/ function(module, exports, __webpack_require__) {
	...
	function renderQuestion(f) {
	  return _underscore2.default.map(_Util2.default.trim(f.question).split('\n'), function (line) {
	    return line + '<br />';
	  }).join('');
	}
	...
	_Sheet2.default.load(SPREADSHEET_ID, 3, function (rows) {
	  var faq = _underscore2.default.map(rows, function (row) {
	    return _Sheet2.default.parseRow(row);
	  }),
	      introHeader = faq[0].introheader,
	      sideColumn = _underscore2.default.map(faq[0].sidecolumn.split('\n'), function (l) {
	    return '<li>' + l + '</li>';
	  });
	
	  (0, _jquery2.default)('.faq-intro').html(introHeader);
	  (0, _jquery2.default)('.faq-aside').html(sideColumn);
	  (0, _jquery2.default)('.faq-questions').html(_underscore2.default.map(faq, function (f, i) {
	    return '<li><a href="#q' + i + '">- ' + renderQuestion(f) + '</a></li>';
	  }).join(''));
	
	  (0, _jquery2.default)('.faq-answers').html(_underscore2.default.map(faq, function (f, i) {
